...
SEMANTIC_ANN_DIR = os.path.join(DATA_DIR, 'processed', 'HEBREW',
                                'semantic-annotations')
INSTANCE_ANN_DIR = os.path.join(DATA_DIR, 'processed', 'HEBREW',
                                'instance-annotations')
IMG_DIR = os.path.join(DATA_DIR, 'processed', 'HEBREW', 'images')
OUT_DIR = os.path.join(DATA_DIR, 'processed', 'HEBREW', 'lmdb')
...
for subset in ['training', 'validation']:
    lst_filepath = os.path.join(DATA_DIR, 'metadata', 'HEBREW', subset + '.lst')
